...
layout(std430, binding = 4) readonly buffer PointLightIndices
{
    uint pointLightIndices[];
};

layout(std430, binding = 5) readonly buffer SpotLightIndices
{
    uint spotLightIndices[];
};

layout(std430, binding = 6) readonly buffer LightProbeIndices
{
